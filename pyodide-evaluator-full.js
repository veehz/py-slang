...
You called ${this.functionName}() without providing the required positional argument ${this.missingParamName}. Make sure to pass all required arguments when calling ${this.functionName}.`;
	...
	*/
	...
	function requireLevenshtein () {
		if (hasRequiredLevenshtein) return levenshtein.exports;
		...
		return levenshtein.exports;
	}

	requireLevenshtein();

	// const levenshtein = require('fast-levenshtein');
	new Token(TokenType.AT, "", 0, 0, 0);
...
`;
	...
	class PyodideEvaluatorFull extends PyodideEvaluator {
	    ...
	    validateChunk(_chunk) { }
	}
	m(PyodideEvaluatorFull);

})();
//# sourceMappingURL=pyodide-evaluator-full.js.map
